...
RUN go install github.com/onsi/ginkgo/v2/ginkgo@v2.15.0 && mv /go/bin/ginkgo /go/bin/ginkgo2 && \
    ...
    go install k8s.io/code-generator/cmd/client-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/conversion-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/deepcopy-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/defaulter-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/informer-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/lister-gen@v0.27.10 && \
    go install k8s.io/code-generator/cmd/openapi-gen@v0.27.10 && \
